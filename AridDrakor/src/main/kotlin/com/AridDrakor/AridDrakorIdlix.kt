 ...
 * ================== IDLIX SOURCE ==================
 *
 * Sumber tambahan untuk AridDrakor. Katalog, detail, pencarian, dan metadata
 ...
 *
 * DIAGNOSTIK: filter logcat dengan tag "AridDrakorIDX".
 *
 * Seluruh DTO sengaja nested di dalam object ini supaya nama seperti Cast dan
 * Genre tidak bentrok dengan data class TMDB milik AridDrakor.
 */
object AridDrakorIdlix {

    private const val IDX_TAG = "AridDrakorIDX"

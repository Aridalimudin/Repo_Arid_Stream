 ...
 * ================== IDLIX SOURCE ==================
 *
 * Sumber tambahan untuk AridFilmSemi. Katalog, detail, pencarian, dan metadata
 ...
 *
 * DIAGNOSTIK: filter logcat dengan tag "AridFilmSemiIDX".
 *
 * Seluruh DTO sengaja nested di dalam object ini supaya nama seperti Cast dan
 * Genre tidak bentrok dengan data class TMDB milik AridFilmSemi.
 */
object AridFilmSemiIdlix {

    private const val IDX_TAG = "AridFilmSemiIDX"

 ...
 * ================== IDLIX SOURCE ==================
 *
 * Sumber tambahan untuk Aridcinemax21. Katalog, detail, pencarian, dan metadata
 ...
 *
 * DIAGNOSTIK: filter logcat dengan tag "Aridcinemax21IDX".
 *
 * Seluruh DTO sengaja nested di dalam object ini supaya nama seperti Cast dan
 * Genre tidak bentrok dengan data class TMDB milik Aridcinemax21.
 */
object Aridcinemax21Idlix {

    private const val IDX_TAG = "Aridcinemax21IDX"

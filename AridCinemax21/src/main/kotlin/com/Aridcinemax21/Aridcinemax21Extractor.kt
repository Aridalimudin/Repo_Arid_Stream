...
object Aridcinemax21Extractor : Aridcinemax21() {
    ...
    private const val KK_TAG = "Aridcinemax21KK"
    ...
    // ditangani TMDB di Aridcinemax21.
    //
    // Alur: TMDB load() -> LinkData -> loadLinks() -> invokeMoviebox()
    //       -> search/v2 -> season-info -> play-info -> ExtractorLink (+ Cookie)
    //
    // DIAGNOSTIK: filter logcat dengan tag "Aridcinemax21MB".
    private const val MB_TAG = "Aridcinemax21MB"

    /**
     * Dipanggil dari Aridcinemax21Plugin.load(). Menyiapkan identity persisten
        ...
        finalStreams.forEach { stream ->
            ...
            callback.invoke(
                newExtractorLink("MovieBox", label, streamUrl, INFER_TYPE) {
                    ...
                    // Cookie di sini dibaca lagi oleh Aridcinemax21.getVideoInterceptor()
    ...
    private object MovieboxHelper {
        ...
        //   sini : SharedPreferences("Aridcinemax21_identity")["apkdeviceid"]
        //
        ...
        // ---------------------------------------------------------------
        private const val ID_PREFS = "Aridcinemax21_identity"
